-- Für bestehende Installationen nach schema.sql ausführen.
ALTER TABLE visits ADD COLUMN IF NOT EXISTS planned_visit_id INT NULL;
ALTER TABLE visits ADD INDEX IF NOT EXISTS ix_visits_planned_visit (planned_visit_id);
...
ALTER TABLE audit_log ADD COLUMN IF NOT EXISTS result VARCHAR(30) NOT NULL DEFAULT 'success';
ALTER TABLE audit_log ADD COLUMN IF NOT EXISTS ip_address VARCHAR(45);
ALTER TABLE audit_log ADD COLUMN IF NOT EXISTS device_id VARCHAR(100);
